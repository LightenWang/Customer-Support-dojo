...
public class FormatDateTag extends TagSupport {
    ...
    public void setDateStyle(String dateStyle) {
        this.dateStyle = StringUtils.isBlank(dateStyle) ? null : Style.valueOf(dateStyle.toUpperCase());
    }

    public void setTimeStyle(String timeStyle) {
        this.timeStyle = StringUtils.isBlank(timeStyle) ? null : Style.valueOf(timeStyle.toUpperCase());
    }
    ...
    public void setSeparateDateTimeWith(String separateDateTimeWith) {
        this.separateDateTimeWith = StringUtils.isBlank(separateDateTimeWith) ? " " : separateDateTimeWith;
    }
