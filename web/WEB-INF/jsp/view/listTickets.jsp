<%--@elvariable id="ticketDatabase" type="java.util.Map<Integer, com.pidojo.Ticket>"--%>
    ...
    <c:choose>
        ...
        <c:otherwise>
            <c:forEach items="${ticketDatabase}" var="entry">
                ...
                <c:out value="${pidojo:abbreviateString(entry.value.subject, 60)}" />
                </a><br/>
                <c:out value="${entry.value.customerName}" /> created ticket
                <pidojo:formatDate value="${entry.value.dateCreated}" type="both"
